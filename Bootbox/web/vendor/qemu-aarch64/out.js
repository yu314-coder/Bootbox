...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("qemu-system-aarch64.wasm");
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL("qemu-system-aarch64.wasm", import.meta.url).href;
}
...
var PThread = {
  ...
  allocateUnusedWorker() {
    ...
    worker = new Worker(new URL("qemu-system-aarch64", import.meta.url), {
      "type": "module",
      // This is the way that we signal to the node worker that it is hosting
      // a pthread.
      "workerData": "em-pthread",
...
var _ntohs, _htonl, _htons, _free, _malloc, _main, _raise, _pthread_self, __emscripten_tls_init, _emscripten_builtin_memalign, __emscripten_proxy_main, __emscripten_thread_init, __emscripten_thread_crashed, __emscripten_run_on_main_thread_js, __emscripten_thread_free_data, __emscripten_thread_exit, __emscripten_check_mailbox, _setThrew, _emscripten_stack_set_limits, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, dynCall_v, dynCall_ji, dynCall_viii, dynCall_iiii, dynCall_ii, dynCall_vi, dynCall_vii, dynCall_vji, dynCall_ijiii, dynCall_iji, dynCall_viji, dynCall_iii, dynCall_viiii, dynCall_viiiii, dynCall_iiiii, dynCall_ij, dynCall_iiiiii, dynCall_iiiiiii, dynCall_jii, dynCall_viij, dynCall_iiiiij, dynCall_iiij, dynCall_iiiji, dynCall_jiji, dynCall_vijji, dynCall_iijiii, dynCall_iijjii, dynCall_iij, dynCall_iiiiji, dynCall_viiiiiii, dynCall_vijii, dynCall_jij, dynCall_vij, dynCall_iiji, dynCall_ijiiii, dynCall_viijj, dynCall_jiijj, dynCall_viijii, dynCall_vijiii, dynCall_vijj, dynCall_i, dynCall_vjiii, dynCall_jj, dynCall_viiiijjii, dynCall_iijji, dynCall_iijj, dynCall_jijii, dynCall_iiiiiiii, dynCall_viiiiii, dynCall_viiiiiiii, dynCall_iiiijii, dynCall_iiiij, dynCall_iijiiiii, dynCall_vijjiiiiii, dynCall_jjji, dynCall_jji, dynCall_vjji, dynCall_jjii, dynCall_jiii, dynCall_ijii, dynCall_jjjji, dynCall_jijj, dynCall_jjj, dynCall_jjiii, dynCall_jiij, dynCall_ijj, dynCall_viiji, dynCall_viiiji, dynCall_jiiii, dynCall_jjiiii, dynCall_viiijii, dynCall_viiiiji, dynCall_jiiij, dynCall_viiij, dynCall_viiiij, dynCall_jijjiiii, dynCall_vjii, dynCall_jjjjii, dynCall_iijiiiji, dynCall_fff, dynCall_ddd, dynCall_jijjji, dynCall_iijii, dynCall_jijji, dynCall_j, dynCall_iiijj, dynCall_iiiiiiiii, dynCall_iiijjiii, dynCall_iijjiii, dynCall_iijiiii, dynCall_iijjiiii, dynCall_iiijijjii, dynCall_iiijiiiii, dynCall_vijjii, dynCall_iidiiii, _asyncify_start_unwind, _asyncify_stop_unwind, _asyncify_start_rewind, _asyncify_stop_rewind;
...
function assignWasmExports(wasmExports) {
  ...
  dynCalls["iiiiji"] = dynCall_iiiiji = wasmExports["dynCall_iiiiji"];
  ...
  dynCalls["jj"] = dynCall_jj = wasmExports["dynCall_jj"];
  ...
  dynCalls["iiiijii"] = dynCall_iiiijii = wasmExports["dynCall_iiiijii"];
  dynCalls["iiiij"] = dynCall_iiiij = wasmExports["dynCall_iiiij"];
  dynCalls["iijiiiii"] = dynCall_iijiiiii = wasmExports["dynCall_iijiiiii"];
  dynCalls["vijjiiiiii"] = dynCall_vijjiiiiii = wasmExports["dynCall_vijjiiiiii"];
  dynCalls["jjji"] = dynCall_jjji = wasmExports["dynCall_jjji"];
  dynCalls["jji"] = dynCall_jji = wasmExports["dynCall_jji"];
  dynCalls["vjji"] = dynCall_vjji = wasmExports["dynCall_vjji"];
  dynCalls["jjii"] = dynCall_jjii = wasmExports["dynCall_jjii"];
  dynCalls["jiii"] = dynCall_jiii = wasmExports["dynCall_jiii"];
  dynCalls["ijii"] = dynCall_ijii = wasmExports["dynCall_ijii"];
  ...
  dynCalls["jjiii"] = dynCall_jjiii = wasmExports["dynCall_jjiii"];
  dynCalls["jiij"] = dynCall_jiij = wasmExports["dynCall_jiij"];
  dynCalls["ijj"] = dynCall_ijj = wasmExports["dynCall_ijj"];
  dynCalls["viiji"] = dynCall_viiji = wasmExports["dynCall_viiji"];
  dynCalls["viiiji"] = dynCall_viiiji = wasmExports["dynCall_viiiji"];
  dynCalls["jiiii"] = dynCall_jiiii = wasmExports["dynCall_jiiii"];
  dynCalls["jjiiii"] = dynCall_jjiiii = wasmExports["dynCall_jjiiii"];
  dynCalls["viiijii"] = dynCall_viiijii = wasmExports["dynCall_viiijii"];
  dynCalls["viiiiji"] = dynCall_viiiiji = wasmExports["dynCall_viiiiji"];
  dynCalls["jiiij"] = dynCall_jiiij = wasmExports["dynCall_jiiij"];
  dynCalls["viiij"] = dynCall_viiij = wasmExports["dynCall_viiij"];
  dynCalls["viiiij"] = dynCall_viiiij = wasmExports["dynCall_viiiij"];
  dynCalls["jijjiiii"] = dynCall_jijjiiii = wasmExports["dynCall_jijjiiii"];
  dynCalls["vjii"] = dynCall_vjii = wasmExports["dynCall_vjii"];
  dynCalls["jjjjii"] = dynCall_jjjjii = wasmExports["dynCall_jjjjii"];
  dynCalls["iijiiiji"] = dynCall_iijiiiji = wasmExports["dynCall_iijiiiji"];
  dynCalls["fff"] = dynCall_fff = wasmExports["dynCall_fff"];
  dynCalls["ddd"] = dynCall_ddd = wasmExports["dynCall_ddd"];
