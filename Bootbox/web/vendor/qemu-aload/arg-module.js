...
[
    ...
    //  • tb-size 256 was tested → FLASK import 29s vs 32s (within noise) for +64 MB wasm-heap resident
    //    (real iPad OOM risk) → reverted to 192.
    ...
    "-nographic", "-m", "256M", "-accel", "tcg,tb-size=192,thread=multi", "-smp", "2",
    "-L", "/pack/",
