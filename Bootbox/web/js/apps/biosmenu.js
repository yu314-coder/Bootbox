...
(function () {
  ...
  const SYSTEMS = [
    ...
    { id: "android64", name: "Android 12 AOSP — Full 64-bit", sub: "Experimental x86_64 Android · touch + keyboard · System UI + Launcher3", icon: "🤖", tag: "ANDROID",
      guest: "android64", ram: 1280,
      note: "Full Android 12 AOSP in the 64-bit QEMU-Wasm engine: Android framework, ART, System UI, Launcher3, writable /data, direct touchscreen and keyboard input. The first download is ~591 MB and is cached by Bootbox. This is an experimental software-emulated guest: the QEMU engine starts quickly, but Android cold boot currently takes several minutes and can take over ten minutes to draw System UI. No Google Play, GMS, Play certification, hardware GPU acceleration, or game-level performance." },
